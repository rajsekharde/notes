...
- 3 Sum: sorting, two-pointer
- 3 Sum Closest: sorting, two-pointer
...
Finding duplicates in array / comparing strings
- sort the array
- duplicate elements will be placed consecutively
- iterate through arrays and compare elements

Two-Pointer
- used to check if two elements in an array satisfy some condition
- keep moving the pointers to get closer to solution
