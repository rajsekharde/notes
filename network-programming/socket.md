...
A way to speak to other programs using standars Unix file descriptors. It's a communication endpoint used by programs to send and receive data over a network.
